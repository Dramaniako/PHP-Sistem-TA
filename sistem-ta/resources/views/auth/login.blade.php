...
<body class="bg-gray-100 flex items-center justify-center min-h-screen p-4">
    ...
    {{-- KARTU MENGAMBANG --}}
    <div
        class="flex w-full max-w-4xl bg-white rounded-2xl shadow-2xl overflow-hidden transform hover:scale-[1.01] transition-transform duration-300">
        ...
        <div class="hidden md:flex w-1/2 bg-neutral-900 text-white flex-col justify-center items-center p-12 relative">
            <div class="relative z-10 text-center">
                <div
                    class="w-24 h-24 bg-neutral-800 rounded-2xl mx-auto mb-6 flex items-center justify-center text-5xl shadow-lg border border-neutral-700">
                    🛡️
                </div>
        ...
        <div class="w-full md:w-1/2 p-8 md:p-12">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-6">
                    <div class="flex justify-between items-center mb-2 ml-1">
                        ...
                        <a href="{{ route('password.request') }}"
                            class="text-xs text-blue-600 hover:text-blue-800 hover:underline">Lupa Password?</a>
                    </div>
                ...
                <button type="submit"
                    class="w-full bg-neutral-900 hover:bg-black text-white font-bold py-3.5 rounded-xl shadow-lg shadow-gray-300/50 transition duration-200 transform hover:-translate-y-0.5">
                    Masuk Sekarang
                </button>

                <div class="mt-8 text-center">
                    <p class="text-sm text-gray-500">Belum punya akun?
                        <a href="{{ route('register') }}" class="font-bold text-blue-600 hover:text-blue-800">Daftar
                            disini</a>
                    </p>
                </div>
            </form>
